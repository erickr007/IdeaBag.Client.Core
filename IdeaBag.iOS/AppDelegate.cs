...
namespace IdeaBag.Client.iOS
{
	...
	public class AppDelegate : UIApplicationDelegate
	{
		...
		public string appId = "125214101154103";
		public string appName = "IdeaBag";
		...
		public override bool FinishedLaunching (UIApplication application, NSDictionary launchOptions)
		{
			...
			Window.RootViewController = new IdeaBag.Client.iOS.Views.SelectUsernameViewController ();//CreateAccountViewController ();//RootTabBarController ();
